...
login_data = {
    ...
    "username": "BoxMineSs6", # đổi thành username acc mcserver vào đây

    "email": "", # hoặc dùng mail để mail thì thôi username 

    "password": {

        "value": "012686az@", # password điền vào 
...
sub_url = "https://www.mcserverhost.com/api/servers/8957c950/subscription" # dán vào đây 
